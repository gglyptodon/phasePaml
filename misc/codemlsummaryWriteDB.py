...
def checkDB(dbname):
    ...
    cmd = 'CREATE TABLE IF NOT EXISTS codeml_w_prank (key TEXT PRIMARY KEY NOT NULL, dataset TEXT, grp TEXT, GeneA TEXT, GeneB TEXT, w_longest FLOAT, w_def FLOAT, w_max FLOAT, w_sum FLOAT);'
    #print(cmd)
    c.execute(cmd)
    db.commit()
